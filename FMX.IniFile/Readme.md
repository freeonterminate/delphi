...
begin
  IniFile := CreateIniFile('会社名'); // Windows では必須です
...
この結果、FMX.IniFile を OS X / iOS で使用するためには、正当な Delphi/C++Builder/RAD Studio の利用者で無ければなりません。

それ以外のファイルについては、商用・非商用に関わらず自由に使用して構いませんが、著作権は放棄していません。
